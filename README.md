...
| Board | MCU | Marlin | Klipper | WiFi | Min Marlin |
|---|---|---|---|---|---|
| BigTreeTech GTR V1.0 (F407) | STM32F407 | yes | yes | - | 2.0.0 |
| BigTreeTech Kraken V1.0 (H723) | STM32H723ZG | yes | pending cfg | - | 2.1.3 |
| BigTreeTech Manta E3 EZ V1.0 | STM32G0B1 | yes | yes | - | 2.1.2 |
| BigTreeTech Manta M4P | STM32G0B1 | yes | yes | - | 2.1.2 |
| BigTreeTech Manta M5P V1.0 (G0B1) | STM32G0B1RE | yes | yes | - | 2.1.2 |
| BigTreeTech Manta M8P V1.1 (G0B1) | STM32G0B1 | yes | yes | - | 2.1.2 |
| BigTreeTech Manta M8P V2.0 | STM32H723ZE | yes | yes | - | 2.1.2 |
| BigTreeTech Octopus Max EZ V1.0 (H723) | STM32H723 | yes | yes | yes | 2.1.2 |
| BigTreeTech Octopus Pro V1.0 (F446) | STM32F446 | yes | yes | yes | 2.1.1 |
| BigTreeTech Octopus Pro V1.1 (H723) | STM32H723ZE | yes | yes | yes | 2.1.2 |
| BigTreeTech Octopus V1.1 | STM32F446ZE | yes | yes | yes | 2.0.9.4 |
| BigTreeTech SKR 1.3 (LPC1768) | LPC1768 | yes | yes | - | 2.0.0 |
| BigTreeTech SKR 1.4 (LPC1768) | LPC1768 | yes | yes | - | 2.0 |
| BigTreeTech SKR 1.4 Turbo (LPC1769) | LPC1769 | yes | yes | - | 2.0 |
| BigTreeTech SKR 2.0 (F407) | STM32F407VG | yes | yes | yes | 2.0.9.3 |
| BigTreeTech SKR 3 | STM32H743VI, STM32H723VG | yes | yes | yes | 2.1.2 |
| BigTreeTech SKR 3 EZ | STM32H743VI, STM32H723VG | yes | yes | yes | 2.1.2 |
| BigTreeTech SKR E3 Turbo (LPC1769) | LPC1769 | yes | yes | - | 2.0.7 |
| BigTreeTech SKR Mini E3 V1.2 (F103) | STM32F103 | yes | yes | - | 2.0.5 |
| BigTreeTech SKR Mini E3 V2.0 (F103) | STM32F103RC | yes | yes | - | 2.0.7 |
| BigTreeTech SKR Mini E3 V3.0 | STM32G0B1RE | yes | yes | - | 2.1 |
| BigTreeTech SKR Mini MZ V1.0 (F103) | STM32F103 | yes | yes | - | 2.0.7 |
| BigTreeTech SKR Pico V1.0 (RP2040) | RP2040 | yes | yes | - | 2.1 |
| BigTreeTech SKR Pro V1.2 (F407) | STM32F407 | yes | yes | yes | 2.0.0 |
| Creality V4.2.10 (F103) | STM32F103 | yes | yes | - | 2.1.1 |
| Creality V4.2.2 (F103) | STM32F103RE | yes | yes | - | 2.0.8 |
| Creality V4.2.7 (F103) | STM32F103RE | yes | yes | - | 2.0.8 |
| FYSETC Cheetah V2.0 (F401) | STM32F401 | yes | yes | - | 2.0.9 |
| FYSETC F6 V1.3 (ATmega2560) | ATmega2560 | yes | yes | - | 2.0.0 |
...
| MKS RUMBA32 V1.0 (F446) | STM32F446 | yes | yes | - | 2.0.0 |
| MKS Robin E3 (F103) | STM32F103 | yes | yes | - | 2.0.7 |
| MKS Robin Nano V2 (F103) | STM32F103 | yes | yes | - | 2.0.7 |
| MKS Robin Nano V3 (F407) | STM32F407VG | yes | yes | - | 2.0.9.3 |
| MKS Robin Nano V3.1 (F407) | STM32F407VE | yes | yes | - | 2.1 |
| MKS SGEN_L V1 (LPC1768) | LPC1768 | yes | yes | - | 2.0.0 |
| MKS SGEN_L V2 (LPC1769) | LPC1769 | yes | yes | - | 2.0.8 |
| Mellow Fly E3 V2 (F407) | STM32F407 | yes | yes | yes | 2.0.9 |
| Einsy Rambo (Prusa MK3 class, ATmega2560) | ATmega2560 | yes | yes | - | 2.0 |
| Mini Rambo (ATmega2560) | ATmega2560 | yes | yes | - | 2.0.0 |
| Rambo (ATmega2560) | ATmega2560 | yes | yes | - | 2.0.0 |
